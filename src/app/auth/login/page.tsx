...
import {
  ...
  ZelligeSVG,
  GoldCornerAccent,
} from "@/components/ui/MoroccanDecor";
    ...
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4">
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="relative p-6 rounded-2xl border border-[var(--border-glass)] bg-[var(--bg-card)] overflow-hidden">
          <GoldCornerAccent position="top-left" />
          <GoldCornerAccent position="top-right" />
          <GoldCornerAccent position="bottom-left" />
          <GoldCornerAccent position="bottom-right" />
          <ZelligeSVG
            variant="diamond"
            opacity={0.025}
            color="#e11d48"
        ...
        <p className="text-sm text-center text-[var(--text-muted)] mt-5">
          ...
          <Link
            href="/auth/register"
            className="text-[var(--text-accent)] font-semibold hover:text-[var(--text-accent-bright)] transition-colors"
          >
            {t("auth.register")}
          </Link>
        </p>
